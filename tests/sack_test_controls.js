...
var page1 = sack.Frame( "Page 1", -1, -1, 600, 600 );
pages.addPage( page1 );
var page2 = sack.Frame( "Page 2", -1, -1, 600, 600 );
pages.addPage( page2 );
var page3 = sack.Frame( "Page 3", -1, -1, 600, 600 );
pages.addPage( page3 );
var page4 = sack.Frame( "Page 4", -1, -1, 600, 600 );
pages.addPage( page4 );
