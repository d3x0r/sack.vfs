...
console.log( "MNOP=", (( JSOX.stringify({ab:ab}) )) );
console.log( "MNOP=", (( JSOX.stringify({ab:new Uint8Array(ab)}) )) );
console.log( "MNOP=", (( JSOX.stringify({ab:new Uint16Array(ab)}) )) );
console.log( "MNOP=", (( JSOX.stringify({ab:new Uint32Array(ab)}) )) );
console.log( "MNOP=", (( JSOX.stringify({ab:new Int8Array(ab)}) )) );
console.log( "MNOP=", (( JSOX.stringify({ab:new Int16Array(ab)}) )) );
console.log( "MNOP=", (( JSOX.stringify({ab:new Int32Array(ab)}) )) );
console.log( "MNOP=", (( JSOX.stringify({ab:new Float32Array(ab)}) )) );
console.log( "MNOP=", (( JSOX.stringify({ab:new Float64Array(ab)}) )) );
